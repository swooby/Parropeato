...
[common/src/main/res/xml/locales_config.xml](common/src/main/res/xml/locales_config.xml)
...
Translations were generated by AI.
If you see anything wrong [please report an issue](issues).

## Help Map Wear OS Button Settings

M. Parropeato can open Samsung Wear OS **Buttons and gestures** settings so users can more easily launch the app from a hardware button.
...
[Please open a GitHub issue](issues) with the watch model, Wear OS / vendor software version, the visible Settings path, and the command output.
