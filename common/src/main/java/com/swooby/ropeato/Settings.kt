...
class Settings(context: Context, val defaultTtsVoiceSpeed: Float = VOICE_SPEED_DEFAULT) {
    private val prefs = context.getSharedPreferences("ropeato_settings", Context.MODE_PRIVATE)
    ...
    var speechRecognizerLocale: String?
        ...
        set(value) = prefs.edit().run {
            if (value != null) putString(KEY_SPEECH_RECOGNIZER_LOCALE, value) else remove(KEY_SPEECH_RECOGNIZER_LOCALE)
            apply()
        }
    ...
    var ttsVoiceSpeed: Float
        ...
        set(value) = prefs.edit().putFloat(KEY_TTS_VOICE_SPEED, value).apply()
    ...
    var ttsPitch: Float
        ...
        set(value) = prefs.edit().putFloat(KEY_TTS_VOICE_PITCH, value).apply()
    ...
    var settingsVersion: Int
        ...
        set(value) = prefs.edit().putInt(KEY_SETTINGS_VERSION, value).apply()
